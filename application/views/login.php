		...
		<div class="header-body text-center mb-7">
			<div class="row justify-content-center">
				<div class="col-lg-5 col-md-6">
					<h1 class="text-white">Welcome and join with us!</h1>
					...
					<form action="<?= base_url('auth/log_in') ?>" method="post" role="form">
						<div class="form-group mb-3">
							<div class="input-group input-group-alternative">
								...
								<input type="text" name="username"
									class="form-control <?= $this->session->flashdata('username') != null?'is-invalid':'' ?>"
									value="<?= $this->session->flashdata('username_val') != null? $this->session->flashdata('username_val') : '' ?>"
						...
						<div class="form-group">
							<div class="input-group input-group-alternative">
								...
								<input name="password"
									class="form-control <?= $this->session->flashdata('password') != null?'is-invalid':'' ?>"
